...
3. Use Tools -> APC Clear Cache to clear the APC cache.

== Frequently Asked Questions ==

= It does not work=

Not all hosts will allow the PHP commands that are necessary to clear the APC cache. There is nothing we can do about that. Sorry.
